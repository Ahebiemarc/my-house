...
const LENGHT_MESSAGE = 10;

type InboxScreenProps = NativeStackScreenProps<TabParamList, "Inbox">;

const DATA: ItemMessageProps[] = Array.from(Array(LENGHT_MESSAGE).keys()).map(
  (_, index) => ({
    id: index.toString(),
